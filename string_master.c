...
int main(int argc, char **argv)
{
	...
	printf("oaie\n"); //Potrei aggiungerlo nella printf sopra a questa ma per rispettare l'inizio della parte da completare inserisco ciò che manca dopo i due punti qui
	printf("\n");
